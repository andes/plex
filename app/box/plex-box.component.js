...
var plex_box_footer_component_1 = require('./plex-box-footer.component');
var PlexBoxComponent = (function () {
    ...
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], PlexBoxComponent.prototype, "ngClass", void 0);
    PlexBoxComponent = __decorate([
        core_1.Component({
            selector: 'plex-box',
            directives: [
                plex_box_footer_component_1.PlexBoxFooterComponent
            ],
...
//# sourceMappingURL=plex-box.component.js.map